...
<body>
    ...
    <section class="login-user">
        <div class="left">
            <img src="{{ asset('frontend/assets/images/ill_login_new.png') }}" alt="">
        </div>
        <div class="right">
            ...
            <p>
                <a class="btn btn-border btn-google-login" href="#">
                    <img src="{{ asset('frontend/assets/images/ic_google.svg') }}" class="icon" alt=""> Sign In with Google
                </a>
            </p>
            <img src="{{ asset('frontend/assets/images/people.png') }}" class="people" alt="">
        </div>
    </section>
